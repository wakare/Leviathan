...
namespace Leviathan
{
	namespace Renderer
	{
		...
		{
		public:
			OpenGL3DObject(unsigned id, GLuint primType, GLfloat* pVertexArrayData, GLuint vertexSize, GLint vertexMask, LPtr<OpenGLMaterial> pMaterial = nullptr, unsigned* pIndexArrayData = nullptr, unsigned uIndexArrayCount = 0U);
