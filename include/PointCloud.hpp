...
namespace Leviathan
{
	...
	inline Leviathan::PointCloud<scalar>::PointCloud(unsigned pointCount, scalar* coordData, scalar* normalData /*= nullptr*/) :
	...
	template<typename scalar>
	inline bool Leviathan::PointCloud<scalar>::HasNormal() const
	{
		return m_bWithNormal;
	}

	template<typename scalar>
	inline bool Leviathan::PointCloud<scalar>::GetCenterAndRadius(scalar* outCenter, scalar& outRadius)
	{
